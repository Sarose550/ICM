...
\begin{enumerate}
  ...
  \item Platform-specific implementations for ARM64 (Apple M3~Max),
    ...
    118\,ms (Sections~\ref{sec:experiments} and~\ref{sec:gpu}).
\end{enumerate}
...
\begin{itemize}
  ...
  \item \textbf{NVIDIA B200 GPU:} 160 SMs, 192\,GB HBM3e,
    8\,TB/s memory bandwidth. CUDA 12.8, cuFFT + cuFFTDx
...
\midrule
1024  & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE]
      & 5 & 9 & 16 & 21 & 25 & 26 \\
2048  & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE]
      & 4 & 7 & 14 & 53 & 59 & 63 \\
4096  & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE]
      & 8 & 16 & 31 & 125 & 138 & 149 \\
8192  & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE]
      & 15 & 29 & 61 & 288 & 330 & 357 \\
16384 & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE]
      & 31 & 59 & 112 & 696 & 802 & 849 \\
32768 & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE]
      & 62 & 139 & 225 & 1696 & 1862 & 2005 \\
65536 & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE] & [UPDATE]
      & 129 & 276 & 466 & 3967 & 4446 & 4699 \\
\bottomrule
\end{tabular}
\end{table}
...
Table~\ref{tab:accuracy} shows convergence of the maximum relative error
for Gauss (erfc-trap) and tanh-sinh quadrature on uniform stacks, measured
against closed-form $V_2$ equities.

\begin{table}[t]
\centering
\caption{Maximum relative error vs.\ quadrature order $Q$, uniform stacks,
  $k = n$. Gauss = erfc-trap; TS = tanh-sinh. Measured against closed-form
  $V_2$ equities on Zen~4.}
\label{tab:accuracy}
...
$Q$ & Gauss & TS & Gauss & TS \\
\midrule
4    & $3.9$                & $2.5 \times 10^{-1}$  & $3.9$                & $2.5 \times 10^{-1}$  \\
8    & $6.2 \times 10^{-3}$ & $1.0$                 & $6.2 \times 10^{-3}$ & $1.0$                 \\
16   & $1.6 \times 10^{-1}$ & $6.6 \times 10^{-1}$  & $1.6 \times 10^{-1}$ & $6.6 \times 10^{-1}$  \\
32   & $4.3 \times 10^{-3}$ & $8.5 \times 10^{-4}$  & $4.3 \times 10^{-3}$ & $8.5 \times 10^{-4}$  \\
64   & $3.0 \times 10^{-7}$ & $1.5 \times 10^{-4}$  & $3.0 \times 10^{-7}$ & $1.5 \times 10^{-4}$  \\
128  & $1.3 \times 10^{-12}$& $1.5 \times 10^{-11}$ & $1.3 \times 10^{-12}$& $1.5 \times 10^{-11}$ \\
256  & $1.7 \times 10^{-12}$& $3.6 \times 10^{-14}$ & $1.7 \times 10^{-12}$& $3.7 \times 10^{-14}$ \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[t]
\centering
\caption{NVIDIA B200 GPU execution time (ms), $Q = 256$.
  Top: $k = n$ (all players paid). Bottom: $k = 100$ (large-field frontier).}
\label{tab:gpu}
\begin{tabular}{@{}rrrr@{}}
\toprule
$n$ & $k$ & Time (ms) & vs.\ Zen~4 serial \\
\midrule
\multicolumn{4}{@{}l}{\emph{$k = n$ (all players paid)}} \\
4{,}096    & $n$ & 1.08  & $138\times$ \\
8{,}192    & $n$ & 2.27  & $157\times$ \\
16{,}384   & $n$ & 4.99  & $170\times$ \\
65{,}536   & $n$ & 24.75 & $190\times$ \\
262{,}144  & $n$ & 117.9 & --- \\
\addlinespace
\multicolumn{4}{@{}l}{\emph{$k = 100$ (large-field frontier)}} \\
65{,}536   & 100 & 6.81  & $68\times$ \\
524{,}288  & 100 & 52.95 & --- \\
1{,}572{,}864 & 100 & 156.2 & --- \\
6{,}291{,}456 & 100 & 626.3 & --- \\
\bottomrule
...
117.9\,ms---a $190\times$ speedup over Zen~4 serial at $n = 65{,}536$.
Larger $k = n$ sizes exceed VRAM (64.9\,GB peak at $n = 262{,}144$).

At $k = 100$, the GPU frontier reaches $n = 6{,}291{,}456$ players in
626\,ms with $Q = 256$, with near-linear scaling in $n$ (the tree depth
grows logarithmically). The frontier is limited by VRAM at large $k$ and
by \emph{tree-level cliffs} at large $n$: each additional tree level
increases compute by ${\sim}10\%$, creating discrete jumps in execution
time.
...
%% - [UPDATE] on M3 Max columns in Tables 1 and 2 (user to measure)
